...
public record CreditSaleDto(Integer id, @NotNull String concept, @NotNull String client, @NotNull LocalDateTime date,
                            @NotNull Double amount, @NotNull Integer branchId, Boolean isPaid, List<PartialDto> partials) {
